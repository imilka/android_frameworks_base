...
public class Clock extends TextView implements OnClickListener, OnLongClickListener {
    ...
    private int getColor() {
        ...
        String curColors[] = null;
        if (ExtendedPropertiesUtils.mIsTablet) {
           curSetting = Settings.System.getString(mContext.getContentResolver(),
        ...
        if (ExtendedPropertiesUtils.mIsTablet) {
            curColors = (curSetting == null || curSetting.equals("") ?
        ...
        return ColorUtils.getComplementaryColor(Color.rgb(red, green, blue), mContext);   
    }
